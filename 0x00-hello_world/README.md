This project is going to achieve the following tasks:
0. gcc -E $CFILE >> c  :a script that runs a C file through the preprocessor and save the result into another file.

The C file name will be saved in the variable $CFILE
The output should be saved in the file c

1. gcc -c $CFILE  :a script that compiles a C file but does not link.
...
3. gcc -o cisfun $CFILE :Write a script that compiles a C file and creates an executable named cisfun.
